...
@section('css')
		...
		<title>{{ config('app.name') }} Third Forms</title>
...
<!-- Page-Title -->
    ...
    <div class="">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">   عرض فاتورة تقرير صيانة </li>
        </ol>
    </div>      
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header bg-success text-white mt-0"><i class="mdi mdi-certificate mr-1"></i>   جميع الفواتير و تقارير الصيانة </h5>
                <div class="card-body">
                    <div class="row form-material">
                        <table id="form-table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td><a href="/Previwform3/{{$Form->id}}" target="_blank" class="btn btn-outline-info waves-effect waves-light"><i class="mdi dripicons-preview mr-2"></i>  عرض   </a></td>
                                <td>
                                    <a href="/EditForm3/{{$Form->id}}"><button type="button" class="btn btn-outline-warning waves-effect waves-light"><i class="mdi mdi-circle-edit-outline mr-2"></i>تعديل  </button></a>
                                </td>
            ...
            function DeleteForm(id) {
                swal({
                    ...
                    cancelButtonText: '<i class="fa fa-thumbs-down"></i> لا',
                        ...
                        xmlhttp.open("GET", "{{url('delete-third-form')}}?id_form="+id, true);
                        xmlhttp.send();
                    }
                })
            };
