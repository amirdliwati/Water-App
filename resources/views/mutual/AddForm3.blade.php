...
@section('css')
		...
		<title>{{ config('app.name') }} Add Form 3</title>
...
<!-- Page-Title -->
    ...
    <div class="">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">   ادخال فاتورة تقرير  صيانة </li>
        </ol>
    </div>      
@endsection
...
@section('content')
<!-- Main content -->
<form id="form" method="POST" action="/Addform3">
  @csrf
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header bg-success text-white mt-0"><i class="mdi mdi-certificate mr-1"></i>    ادخال فاتورة تقرير  صيانة </h5>
                <div class="card-body">
                    <div class="row form-material">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('customer_name') is-invalid @enderror mx" id="customer_name" name="customer_name" value="{{ old('customer_name') }}" autocomplete="customer_name" autofocus required maxlength="90" minlength="3">
                                @error('customer_name')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                    ...
                    <div class="row form-material">
                        <div class="col-md-4">
                          ...
                          <input type="number" class="form-control  @error('counter_number') is-invalid @enderror" id="counter_number" name="counter_number" value="{{ old('counter_number') }}" autocomplete="counter_number" placeholder="" autofocus required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('field1') is-invalid @enderror mx" id="field1" name="field1" value="{{ old('field1') }}" autocomplete="field1" autofocus maxlength="17" minlength="3">
                                @error('field1')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('field2') is-invalid @enderror mx" id="field2" name="field2" value="{{ old('field2') }}" autocomplete="field2" autofocus maxlength="40" minlength="3">
                                @error('field2')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                    ...
                    <div class="row form-material">
                        <div class="col-md-6">
                            <div class="paper">
                                <div class="paper-content">
                                    <textarea type="text" class=" @error('maintenance_time') is-invalid @enderror mx" id="maintenance_time" name="maintenance_time" value="{{ old('maintenance_time') }}" autocomplete="address" placeholder=" مدة الصيانة" autofocus required rows="5"  maxlength="150" minlength="3" data-toggle="tooltip" data-placement="left" title="{{ __('مدة الصيانة')}}" data-parsley-required-message="هذا الحقل مطلوب" > لا يوجد  </textarea>
                        ...
                        <div class="col-md-6">
                            <div class="paper">
                                <div class="paper-content">
                                    <textarea type="text" class=" @error('maintenance_type') is-invalid @enderror mx" id="maintenance_type" name="maintenance_type" value="{{ old('maintenance_type') }}" autocomplete="address" placeholder="  نوع الصيانة " autofocus required rows="5" maxlength="150" minlength="3" data-toggle="tooltip" data-placement="left" title="{{ __(' نوع الصيانة  ')}}" data-parsley-required-message="هذا الحقل مطلوب" >  لا يوجد  </textarea>
                    ...
                    <div class="row form-material">
                        <div class="col-md-4">
                          ...
                          <input type="number" step="0.01" class="form-control  @error('total') is-invalid @enderror ts" id="total" name="total" value="{{ old('total') }}" autocomplete="total" placeholder="" autofocus required>
                          @error('total')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="number" step="0.01" class="form-control  @error('tax') is-invalid @enderror ts" id="tax" name="tax" value="{{ old('tax') }}" autocomplete="tax" placeholder="" autofocus required>
                          @error('tax')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="number" step="0.01" class="form-control  @error('total_amount') is-invalid @enderror" id="total_amount" name="total_amount" value="{{ old('total_amount') }}" autocomplete="total_amount" placeholder="" autofocus readonly>
                          @error('total_amount')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row form-material">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('total_amount_write') is-invalid @enderror mx" id="total_amount_write" name="total_amount_write" value="{{ old('total_amount_write') }}" autocomplete="total_amount_write" autofocus required maxlength="50" minlength="3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('employee') is-invalid @enderror mx" id="employee" name="employee" value="{{ old('employee') }}" autocomplete="employee" autofocus required maxlength="30" minlength="3">
                                @error('employee')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
